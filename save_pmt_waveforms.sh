#!/bin/bash
#SBATCH --qos=regular
#SBATCH --job-name=wf_part1
#SBATCH --output=wf_part1_%A_%a.out
#SBATCH --error=wf_part1_%A_%a.err
...
#SBATCH --array=0-115   # 71 chunks for part0 (17784 events / 250 chunk size ≈ 71)
                         #116 chunks for part1
